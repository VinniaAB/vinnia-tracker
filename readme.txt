...
Installing "Vinnia Tracker" can be done either by searching for "Vinnia Tracker" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
